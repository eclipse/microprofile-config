...
A full list of changes may be found on the (link:https://github.com/eclipse/microprofile-config/milestone/7?closed=1[MicroProfile Config 1.4 Milestone])
=== API/SPI Changes

- ConfigProperty provides the _NULL_VALUE_ to allow _null_ to be provided as a default value for injection.
[source, java]
----
