...
- Property expansion is a MicroProfile Config 2.0 feature. As such, previous versions of the specification would not
evaluate expresions. With property expansion available, there is a chance that previous working configuration won't
work anymore.
