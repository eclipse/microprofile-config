...
public interface ConfigSource {
     ...
     *            <li>Replace the character that is neither alphabetic nor '_' with '_' (i.e. {@code "com_ACME_size"})</li>
     *            <li>Replace the character that is neither alphabetic nor '_' with '_' and convert to upper case (i.e. {@code "COM_ACME_SIZE"})</li>
     *        </ol>
